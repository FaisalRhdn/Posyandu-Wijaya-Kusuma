...
<head>
  ...
  <title>Posyandu Wijaya Kusuma 3</title>
  ...
  <div class="row gy-4">
    <div class="col-lg-5 col-md-12 footer-info">
      <a href="/" class="logo d-flex align-items-center">
        <span>PonPes Darussholihin</span>
      </a>
      <p>Menjunjung tinggi Etika perjuangan Agama agar dapat berpartisipasi aktif sebagai subyek pembangun moral dan Agama nasional.</p>
      <div class="social-links d-flex mt-4">
        ...
        <a href="https://www.youtube.com/@ppdarussholihinbenowotvoff4446" class="linkedin"><i class="bi bi-youtube"></i></a>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
      ...
      <p>
        ...
        Pakal <br>
        Surabaya <br><br>
        <strong>Phone:</strong> +62 813 3513 7003<br>
        <strong>Email:</strong> ponpesdarussholihinbenowo@gmail.com<br>
      </p>
...
<div class="container mt-4">
  <div class="copyright">
    &copy; Copyright <strong><span>UWP</span></strong>. All Rights Reserved
  </div>
  <div class="credits">
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v17.0" nonce="C4yZrNT8"></script>

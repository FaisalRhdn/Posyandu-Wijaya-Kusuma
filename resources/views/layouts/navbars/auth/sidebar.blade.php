<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="../assets/img/icon.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-2 font-weight-bold">Administrator Ponpes Darussholihin</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('posts', 'createposts', 'detailposts*', 'showposts*') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Post Berita
